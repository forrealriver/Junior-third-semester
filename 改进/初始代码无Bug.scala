      ...
      if (c.nonEmpty) {
        ...
        if (Times.Time_Duration_Minutes(A(0).time, last_hour) >= 60) {
          ...
          if(map_data1.count()>=24) {
            ...
            Hbase_insert(conn, "rudr_pr", "1", "hour", "1", ((redict_re_double.toInt.toDouble - redict_re1.toDouble.toInt.toDouble) / redict_re_double.toInt.toDouble).toString)
          }
          ...
          if (last_day == 0) {
            ...
            if(map_data1.count()>=30) {
              ...
              Hbase_insert(conn, "rudr_pr", "1", "day", "1", ((redict_re_double.toInt.toDouble - redict_re1.toDouble.toInt.toDouble) / redict_re_double.toInt.toDouble).toString)
            }
          ...
          if (last_week == 0) {
            ...
            if(map_data.count()>=7) {
              ...
              Hbase_insert(conn,"week_pr","1","values","1",redict_re3)
              ms3=listRow3(1).toString()
              redict_re3=ms3.slice(1,ms3.length-1)
              Hbase_insert(conn,"week_pr","1","values","2",redict_re3)
              ms3=listRow3(2).toString()
              redict_re3=ms3.slice(1,ms3.length-1)
              Hbase_insert(conn,"week_pr","1","values","3",redict_re3)
              ms3=listRow3(3).toString()
              redict_re3=ms3.slice(1,ms3.length-1)
              Hbase_insert(conn,"week_pr","1","values","4",redict_re3)
              ms3=listRow3(4).toString()
              redict_re3=ms3.slice(1,ms3.length-1)
              Hbase_insert(conn,"week_pr","1","values","5",redict_re3)
              ms3=listRow3(5).toString()
              redict_re3=ms3.slice(1,ms3.length-1)
              Hbase_insert(conn,"week_pr","1","values","6",redict_re3)
              ms3=listRow3(6).toString()
              redict_re3=ms3.slice(1,ms3.length-1)
              Hbase_insert(conn,"week_pr","1","values","7",redict_re3)
            }
            ...
            if(map_data1.count()>=7) {
              ...
              Hbase_insert(conn, "rudr_pr", "1", "week", "1", ((redict_re_double.toInt.toDouble - redict_re1.toDouble.toInt.toDouble) / redict_re_double.toInt.toDouble).toString)
            }
          ...
          if (last_month == 0) {
            ...
            if(map_data1.count()>=12) {
              ...
              Hbase_insert(conn, "rudr_pr", "1", "month", "1", ((redict_re_double.toInt.toDouble - redict_re1.toDouble.toInt.toDouble) / redict_re_double.toInt.toDouble).toString)
            }
